...
export class QwenReceiver implements ReceiverRuntime {
    ...
    async execute(request: MessageRequest, hooks: RuntimeHooks): Promise<string> {
        ...
        const args = [
            ...
            '--allowed-tools', 'mcp__pairlobby_receiver__acknowledge_message,mcp__pairlobby_receiver__working_message,mcp__pairlobby_receiver__pass_message',
