...
writeFileSync(join(pkg,'package.json'),JSON.stringify({name:'@pairlobby/cli',version:'0.1.0-demo.2',description:'PairLobby rooms for humans and their coding agents',type:'module',bin:{pairlobby:'dist/main.mjs'},engines:{node:'>=22.18.0'},files:['dist','skills','README.md','THIRD_PARTY_NOTICES.txt']},null,2)+'\n');
...
const archive=join(output,'pairlobby-cli-0.1.0-demo.2.tgz');
